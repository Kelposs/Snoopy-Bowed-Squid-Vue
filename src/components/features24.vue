            ...
            <h2 class="thq-heading-2">
              <slot name="feature1Title">
                ...
                <div class="features24-fragment3">
                  <span class="features24-text3">Personalized Guidance</span>
                </div>
              </slot>
            </h2>
            ...
            <h2 class="thq-heading-2">
              <slot name="feature2Title">
                ...
                <div class="features24-fragment1">
                  <span class="features24-text1">Individualized Support</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
...
export default {
  ...
  props: {
    feature1ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1504723356406-be4223196d7f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM1MXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature2ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1561379982-c9f0e54ff067?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM1MXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature3ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1590940309166-88c429fe3315?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM1MHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature2ImgAlt: {
      type: String,
      default: 'Tailored Advice Image',
    },
    feature3ImgAlt: {
      type: String,
      default: 'Professional Consultation Image',
    },
    feature1ImgAlt: {
      type: String,
      default: 'Consultation Support Image',
    },
  },
  data() {
    return {
