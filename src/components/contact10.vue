          ...
          <h2 class="thq-heading-2">
            <slot name="heading1">
              ...
              <div class="contact10-fragment1">
                <span class="contact10-text16">Contact Us</span>
              </div>
            </slot>
          </h2>
            ...
            <slot name="location1Description">
              ...
              <div class="contact10-fragment6">
                <span class="contact10-text21">
                  Visit us at our office location for a face-to-face consultation.
                </span>
              </div>
            </slot>
          </p>
            ...
            <slot name="location2Description">
              ...
              <div class="contact10-fragment3">
                <span class="contact10-text18">
                  Send us an email with your questions or to book an appointment.
                </span>
              </div>
            </slot>
          </p>
...
export default {
  ...
  props: {
    ...
    location2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1593026238217-97aaf753fe6e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM0N3w&ixlib=rb-4.0.3&q=80&w=1080',
    },
  },
}
</script>
