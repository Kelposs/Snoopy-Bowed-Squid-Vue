            ...
            <h2 class="thq-heading-2">
              <slot name="feature1Title">
                ...
                <div class="features25-fragment3">
                  <span class="features25-text3">Personalized Consultation</span>
                </div>
              </slot>
            </h2>
              ...
              <slot name="feature1Description">
                ...
                <div class="features25-fragment6">
                  <span class="features25-text6">
                    Tailored consultation sessions for each child based on their
            ...
            <h2 class="thq-heading-2">
              <slot name="feature2Title">
                ...
                <div class="features25-fragment2">
                  <span class="features25-text2">Experienced Professionals</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
              <slot name="feature2Description">
                ...
                <div class="features25-fragment1">
                  <span class="features25-text1">
                    Consultation provided by experienced professionals
                    specializing in disabilities and child development.
                  </span>
                </div>
              </slot>
            </span>
            ...
            <h2 class="thq-heading-2">
              <slot name="feature3Title">
                ...
                <div class="features25-fragment4">
                  <span class="features25-text4">Family Support</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
              <slot name="feature3Description">
                ...
                <div class="features25-fragment5">
                  <span class="features25-text5">
                    Guidance and support not only for the child but also for their
                    family members to navigate the challenges together.
                  </span>
                </div>
              </slot>
            </span>
...
export default {
  ...
  props: {
    feature3ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1491590197864-41e7697a0c87?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM1MXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature1ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1640184713845-3fe2e22c33fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM1MHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature1ImgAlt: {
      type: String,
      default: 'Image depicting personalized consultation',
    },
    feature3ImgAlt: {
      type: String,
      default: 'Image representing family support',
    },
    feature2ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/flagged/photo-1555251255-e9a095d6eb9d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM1MXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature2ImgAlt: {
      type: String,
      default: 'Image of experienced professionals',
    },
  },
  data() {
    return {
