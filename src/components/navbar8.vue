  ...
  <header class="navbar8-container1">
    <header data-thq="thq-navbar" class="navbar8-navbar-interactive">
      ...
      <div class="navbar8-container2">
        <span class="navbar8-text10">
          <slot name="text">
            <!--Default content for text-->
            <div class="navbar8-fragment17">
              <span class="navbar8-text20">Text</span>
            </div>
          </slot>
        </span>
        <div data-thq="thq-navbar-nav" class="navbar8-desktop-menu">
          ...
          <div class="navbar8-buttons1"></div>
        </div>
      </div>
      ...
      <div data-thq="thq-mobile-menu" class="navbar8-mobile-menu">
        <div class="navbar8-nav">
          ...
          <nav class="navbar8-links2">
            <a :href="link1Url" class="navbar8-link1 thq-link thq-body-small">
              <slot name="link1">
                <!--Default content for link1-->
                <div class="navbar8-fragment23">
                  <span class="navbar8-text26">#home</span>
                </div>
              </slot>
            </a>
            <a :href="link2Url" class="thq-link thq-body-small">
              <slot name="link2">
                ...
                <div class="navbar8-fragment19">
                  <span class="navbar8-text22">#about</span>
                </div>
              </slot>
            </a>
            <a :href="link3Url" class="navbar8-link3 thq-link thq-body-small">
              <slot name="link3">
                <!--Default content for link3-->
                <div class="navbar8-fragment20">
                  <span class="navbar8-text23">#services</span>
                </div>
              </slot>
            </a>
                    ...
                    <div class="navbar8-content1">
                      ...
                      <span class="thq-body-small">
                        <slot name="page1Description">
                          ...
                          <div>
                            <span>
                              Welcome to our website offering consultation support
                        ...
                        <slot name="page2Description">
                          ...
                          <div>
                            <span>
                              ...
                              dedicated to supporting disabled children.
                            </span>
                          </div>
                        </slot>
                      </span>
                    ...
                    <div class="navbar8-content3">
                      ...
                      <span class="thq-body-small">
                        <slot name="page3Description">
                          ...
                          <div>
                            <span>
                              Explore the range of services we offer to help
                              disabled children thrive and reach their full
                              potential.
                            </span>
                          </div>
                        </slot>
                        ...
                        <slot name="page4Description">
                          ...
                          <div>
                            <span>
                              ...
                              and support for your disabled child.
                            </span>
                          </div>
                        </slot>
                      </span>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment11">
                    <span class="navbar8-text14">Learn More</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment12">
                    <span class="navbar8-text15">Contact Us</span>
                  </div>
                </slot>
              </span>
            </button>
                  ...
                  <slot name="page1Description">
                    ...
                    <div class="navbar8-fragment24">
                      <span class="navbar8-text27">
                        Welcome to our website offering consultation support for
                        disabled children.
                      </span>
                    </div>
                  </slot>
                ...
                <span class="navbar8-page22 thq-body-large">
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment22">
                      <span class="navbar8-text25">About Us</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page2Description">
                    ...
                    <div class="navbar8-fragment21">
                      <span class="navbar8-text24">
                        Learn more about our mission, vision, and team dedicated
                        to supporting disabled children.
                      </span>
                    </div>
                  </slot>
                </span>
                ...
                <span class="thq-body-small">
                  <slot name="page3Description">
                    ...
                    <div class="navbar8-fragment16">
                      <span class="navbar8-text19">
                        Explore the range of services we offer to help disabled
                        children thrive and reach their full potential.
                      </span>
                    </div>
                  </slot>
                </span>
                ...
                <span class="navbar8-page42 thq-body-large">
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment10">
                      <span class="navbar8-text13">Contact Us</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page4Description">
                    ...
                    <div class="navbar8-fragment13">
                      <span class="navbar8-text16">
                        Get in touch with us for personalized consultation and
                        support for your disabled child.
                      </span>
                    </div>
                  </slot>
                </span>
...
export default {
  ...
  props: {
    ...
    page1ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1628720585362-a6d53a2e33d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM0NXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    linkUrlPage4: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page3ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1469199156870-6763539ef2f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM0Nnw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page3ImageAlt: {
      type: String,
    ...
    page4ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1459369510627-9efbee1e6051?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM0Nnw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    linkUrlPage3: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDM5ODM0Nnw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    linkUrlPage1: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    logoAlt: {
      type: String,
      default: 'Consultation Support for Disabled Children',
    },
  },
  data() {
    return {
