          ...
          >
            <slot name="link1">
              ...
              <div class="footer4-fragment6">
                <span class="footer4-text19">Home</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link2">
              ...
              <div class="footer4-fragment8">
                <span class="footer4-text21">Services</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link3">
              ...
              <div class="footer4-fragment5">
                <span class="footer4-text18">About Us</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link5">
              ...
              <div class="footer4-fragment4">
                <span class="footer4-text17">FAQs</span>
              </div>
            </slot>
          </a>
        </div>
            ...
            <span class="thq-body-small">
              <slot name="termsLink">
                ...
                <div class="footer4-fragment3">
                  <span class="footer4-text16">Terms and Conditions</span>
                </div>
              </slot>
            </span>
            <span class="thq-body-small">
